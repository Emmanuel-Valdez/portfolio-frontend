## 1. OpenSpec y trazabilidad

- [x] 1.1 Crear change `pfo1-landing` con `openspec new change`.
- [x] 1.2 Redactar `proposal.md` con motivación, alcance y capability `pfo1-portfolio`.
